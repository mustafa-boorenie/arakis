...
RCT_SCHEMA = ExtractionSchema(
    ...
    fields=[
        ...
        ExtractionField(
            ...
            required=True,
            validation_rules={"allowed_values": ["parallel", "crossover", "cluster", "factorial", "other"]}
        ),
        ...
        ExtractionField(
            ...
            field_type=FieldType.CATEGORICAL,
            required=True,
            validation_rules={"allowed_values": ["placebo", "active_comparator", "usual_care", "no_treatment", "other"]}
        ),
        ExtractionField(
        ...
        ExtractionField(
            ...
            required=False,
            validation_rules={"allowed_values": ["participants", "care_providers", "outcome_assessors", "none"]}
        ),
        ExtractionField(
            name="dropout_rate",
        ...
        ExtractionField(
            ...
            field_type=FieldType.CATEGORICAL,
            required=False,
            validation_rules={"allowed_values": ["industry", "government", "non_profit", "mixed", "unclear", "none"]}
        ),
    ]
)
...
COHORT_SCHEMA = ExtractionSchema(
    ...
    fields=[
        ...
        ExtractionField(
            ...
            field_type=FieldType.CATEGORICAL,
            required=True,
            validation_rules={"allowed_values": ["prospective", "retrospective", "ambidirectional"]}
        ),
...
DIAGNOSTIC_SCHEMA = ExtractionSchema(
    ...
    fields=[
        ...
        ExtractionField(
            ...
            field_type=FieldType.CATEGORICAL,
            required=True,
            validation_rules={"allowed_values": ["cross_sectional", "cohort", "case_control", "other"]}
        ),
