...
const QUICK_ACTIONS = [
  { id: 'pico', label: 'PICO', icon: Sparkles },
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
            Condense{' '}
            <span className="text-purple-600 italic">Hours</span>
            {' '}into{' '}
          ...
          <div className="relative mt-2">
            <div className="absolute -top-8 left-1/4 w-3 h-3 bg-purple-200 rounded-full opacity-60" />
            <div className="absolute -top-4 right-1/3 w-2 h-2 bg-green-300 rounded-full opacity-60" />
            <div className="absolute top-0 right-1/4 w-2 h-2 bg-orange-300 rounded-full opacity-60" />
          </div>
        </div>
              ...
              <div className="flex flex-wrap gap-2">
                {QUICK_ACTIONS.map((action) => {
                  ...
                  return (
                    <button
                      key={action.id}
                      className="flex items-center gap-2 px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-white border border-gray-200 rounded-full transition-colors"
                    >
